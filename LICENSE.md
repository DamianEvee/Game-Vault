...
Se concede permiso para descargar, utilizar y ejecutar el software Game Vault de forma gratuita para uso personal y no comercial, sujeto a las condiciones establecidas en esta licencia.

## Restricciones

Queda expresamente prohibido, sin autorización previa, expresa y por escrito del titular de los derechos:

- Vender el software o cualquier parte del mismo.
- Distribuir copias del software por cualquier medio.
- Modificar, alterar, adaptar o crear trabajos derivados del software.
- Eliminar o modificar avisos de copyright, autoría o licencia.
- Reempaquetar el software para su redistribución.
- Publicar el código fuente completo o parcial en repositorios, sitios web o plataformas de terceros.
- Utilizar el software o su código fuente con fines comerciales.
- Incorporar el software o partes del mismo en otros proyectos sin autorización escrita.
...
Cualquier excepción a las restricciones establecidas en esta licencia requerirá consentimiento previo, explícito y por escrito del titular de los derechos.

## Exclusión de Garantías

El software se proporciona "tal cual", sin garantías de ningún tipo, expresas o implícitas.

El autor no será responsable de daños, pérdidas de datos, interrupciones de servicio o cualquier otro perjuicio derivado del uso o imposibilidad de uso del software.

## Terminación

El incumplimiento de cualquiera de las condiciones de esta licencia resultará en la terminación automática e inmediata de los derechos concedidos por la misma.

## Contacto

Para solicitudes de autorización o consultas relacionadas con esta licencia, contacte con el titular de los derechos.
